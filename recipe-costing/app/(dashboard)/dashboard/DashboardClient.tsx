      ...
      {tab === 'ops' && (
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/inventory" className="bg-white border border-gray-200 rounded-xl p-4 hover:border-blue-300 transition-colors block">
            ...
            <Link href="/production" className="bg-white border border-gray-200 rounded-xl p-4 hover:border-blue-300 transition-colors block">
            ...
            <Link href="/inventory" className={`rounded-xl p-4 hover:opacity-90 transition-opacity block border ${alertCount > 0 ? 'bg-red-50 border-red-200' : 'bg-green-50 border-green-200'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
              <div className="px-4 py-3 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                ...
                <Link href="/production" className="text-xs text-blue-600 hover:text-blue-800">اذهب للإنتاج →</Link>
              </div>
              {opsData.batchesLow.length === 0 ? (
